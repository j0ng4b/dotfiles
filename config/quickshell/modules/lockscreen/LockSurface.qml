        ...
        Rectangle {
            ...
            MouseArea {
                ...
                onPositionChanged: {
                    ...
                    clockContainer.scaleFactor = Math.min(clockContainer.maxScaleFactor, Math.max(clockContainer.minScaleFactor, clockContainer.scaleFactor + dx / 300));
                }
            }
        }
        ...
        Rectangle {
            ...
            MouseArea {
                ...
                onPositionChanged: {
                    ...
                    clockContainer.scaleFactor = Math.min(clockContainer.maxScaleFactor, Math.max(clockContainer.minScaleFactor, clockContainer.scaleFactor + dy / 300));
                }
            }
        }
        ...
        Rectangle {
            ...
            MouseArea {
                ...
                onPositionChanged: {
                    ...
                    clockContainer.scaleFactor = Math.min(clockContainer.maxScaleFactor, Math.max(clockContainer.minScaleFactor, clockContainer.scaleFactor + delta / 300));
                }
            }
        }
    }
