...
window "#[fg=$base01 bg=$base00]#[fg=$base02 bg=$base01]"
window "#[fg=$base04 bg=$base02] #{window_index} #{window_name}#{window_flag} "
window "#[fg=$base02 bg=$base01]#[fg=$base01 bg=$base00]"
...
window "#[fg=$base03 bg=$base00]#{?client_prefix,#[fg=$base09 bg=$base03 nobold],#[fg=$base0B bg=$base03 nobold]}"
window "#{?client_prefix,#[fg=$base04 bg=$base09 bold],#[fg=$base04 bg=$base0B bold]} #{window_index} #{window_name}#{window_flag} "
window "#{?client_prefix,#[fg=$base09 bg=$base03 nobold],#[fg=$base0B bg=$base03 nobold]}#[fg=$base03 bg=$base00]"
